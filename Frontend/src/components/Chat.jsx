...
export default function Chat() {
  const [conversations, setConversations] = useState([
    {
      id: "default",
      title: "SAP MM Chat",
      messages: [{ role: "assistant", text: "Hi! Say 'help' to see available commands." }],
      updatedAt: Date.now(),
    },
  ]);
    ...
    setConversations((prev) => [
      {
        id,
        title: "New chat",
        messages: [{ role: "assistant", text: "Hello! What do you want to do in SAP?" }],
        updatedAt: Date.now(),
      },
      ...prev,
    ]);
  ...
  async function onSend({ overrideText, fromEdit = false } = {}) {
    ...
    try {
      ...
      updateActiveMessages((m) => [...m, { role: "assistant", text: data.reply ?? "" }]);
    } catch (e) {
